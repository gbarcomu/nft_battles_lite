    ...
    <Container>
      ...
      <Modal show={show} onHide={handleClose} size="xl">
        ...
        <Modal.Body>
          ...
          <p>One (pseudo) random number will be generated for each fight. You need to score a 30/50/70 (favourable/neutral/unfavourable) or more to be victorious. <b>Win 2 or more individual fights for winning the battle</b>. You'll be rewarded with <b>80 units of gold if you win or 20 if you lose</b>.</p>
